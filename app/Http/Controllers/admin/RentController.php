...
class RentController extends Controller
{
    ...
    {
        $properties = Property::whereJsonContains('types', ['Rent'])->orderBy('id','desc')->paginate(6);
        return view('backend.types.rents.index', compact('properties'))->with('properties', $properties);
    }
