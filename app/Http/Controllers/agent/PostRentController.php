...
class PostRentController extends Controller
{
    /**
    ...
    {
        $properties= Property::where('agent_id','=', Auth::user()->id)->whereJsonContains('types', ['Rent'])->orderBy('id','desc')->paginate(6);
        return view('agent.types.rents.index', compact('properties'));
    }
