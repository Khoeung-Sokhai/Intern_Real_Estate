...
@section('content')
    ...
    <div class="content-wrapper px-5 mt-4">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('posts.update', $properties->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="amenity" value="{{  $properties->amenity  }}" id="exampleInputName1"
                                    ...
                                    <div class="form__files-container" id="files-list-container">
                                        @if (count($properties->images) > 0)
                                            @foreach ($properties->images as $img)
                                                <a class="form__image-container" href="{{ url('manager/property-image/'.$img ->id.'/deleteimage') }}" >
