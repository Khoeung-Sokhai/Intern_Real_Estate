                                ...
                                <div class="item col-lg-4 col-md-6 col-xs-12 landscapes sale">
                                    <div class="project-single" data-aos="fade-up">
                                        <div class="project-inner project-head">
                                            <div class="homes">
                                                ...
                                                <a href="{{ route('detailall.show', $property->id) }}" class="homes-img">
                                                    ...
                                                    <div class="homes-price"> Start from: $ {{ $property->price_Rental }}
                                                    </div>
                                                   
                                                    {{-- @foreach($property->types as $type)
                                                    @if($type == 'Sale') 

                                                        <div class="homes-price"> $1.00/month
                                                        </div>
                                                    @endif
                                                    @if($type == 'Rent')

                                                        <div class="homes-price"> $2.00/month
                                                        </div>
                                                    @endif
                                                    @if($type == 'Rental')

                                                        <div class="homes-price"> $3.00/month
                                                        </div>
                                                    @endif
                                                    @endforeach --}}
                                                        ...
                                                        <div class="news-item-img">
                                                            <img class="img-responsive"
                                                                src="{{ asset('/cover/' . $property->cover) }}"
                                                                style="height:250px; width:1000px" alt="blog image">
                                                        </div>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="homes-content">
                                            <!-- homes address -->
                                            <h3><a
                                                    href="{{ route('detailall.show', $property->id) }}">{{ $property->name }}</a>
                                            </h3>
                                            <p class="homes-address mb-3">
                                                <a href="{{ route('detailall.show', $property->id) }}">
                                        ...
                                        <span> Garages</span>
                                            ...
                                            <div class="footer">
                                                <a href="/agent">
                                                    <img src="/profiles/avatars/{{ $property->agent->avatar }} "
                                                        alt="author-image" class="img-circle elevation-2"> Prepare by,
                                                    {{ $property->agent->name }}
                                                </a>
